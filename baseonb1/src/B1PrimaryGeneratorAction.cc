  ...
  fEnvelopeBox(0)
{
  ...
  //fParticleGun->SetParticleMomentumDirection(G4ThreeVector(sqrt(0.96), 0., sqrt(0.04)));


  fParticleGun->SetParticleMomentumDirection(G4ThreeVector(sqrt(0.99), 0., sqrt(0.01)));
//  fParticleGun->SetParticleMomentumDirection(G4ThreeVector(1.0, 0., 0.));
...
//  }
  ...
  fParticleGun->SetParticlePosition(G4ThreeVector(-32.0*cm, 0., -(10.0 + 8.0/4)*cm));
